...
```{=html}
<script>
  // Always start at the top on reload, unless the URL has an anchor (e.g. #map).
  ...
  // LGCE brand and the Overview link should go to the very top of the page,
  // above the H1 title, bypassing the scroll-padding-top offset.
...
<nav class="site-nav" aria-label="Section navigation">
  <div class="site-nav-inner">
    <a class="site-nav-brand" href="#" data-scroll-top>LGCE</a>
    <div class="site-nav-links">
      <a href="#" data-scroll-top>Overview</a>
      <a href="#summary">Summary</a>
      <a href="#how-to-use">Guide</a>
      <a href="#map">Map</a>
      <a href="#cost-index">Cost Index</a>
      <a href="#how-it-works">How it Works</a>
      <a href="#rankings">Boroughs</a>
...
## Where has London grown, and what environmental cost came with that growth? {#overview}
...
## How to Use This Application {#how-to-use}
...
## How the Cost Index is Calculated {#cost-index}
...
## Which Boroughs Show the Highest Cost? {#rankings}
...
## What Did New Development Replace? {#land-use}
...
## How Do Boroughs Compare to the London Average? {#compare}
...
## What the Results Suggest {#insights}
