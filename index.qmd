...
Urban growth was identified by detecting transitions to built-up land using Dynamic World classifications, with analysis restricted to newly developed areas to isolate recent expansion processes.

Environmental impacts were then calculated specifically for these new built-up pixels. Green loss was derived from vegetation-to-built transitions, NDVI loss from changes in vegetation index, heat penalty from differences in land surface temperature, and water-edge pressure from proximity to stable surface water.

All indicators were standardised to ensure comparability across different units and scales, and combined into a composite Growth Cost Index using equal weighting.

Finally, results were aggregated to borough level, enabling comparison of where urban expansion has generated relatively higher environmental cost across London.

This workflow ensures that environmental cost is assessed in direct relation to new development rather than pre-existing urban conditions, providing a more policy-relevant and decision-oriented understanding of spatial patterns of urban growth impact.
### Interface
